...
def test_scoring_news():
    ...
    assert "strongly positive news sentiment (0.40)" in reasons
...
def test_scoring_max_clamp():
    ...
    # earnings: +30, filings: +25, news: +10, sentiment: +10. Total 75.
    # It seems 100 is hard to reach with current rules, but clamp is good practice.
